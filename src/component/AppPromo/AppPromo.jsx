    ...
    <section className="app-promo ">
      <div className="promo-text z-1">
        ...
        <div className="store-buttons">
          ...
          <button className="store-btn flex items-center justify-center gap-2 bg-white px-6 py-3 rounded-lg shadow-md hover:shadow-lg transition-shadow hover:text-green-100">
      ...
      <div className="promo-images">
        {!imageErrors.screen1 ? (
          ...
          <div className="mobile-screen placeholder">App Preview 1</div>
        )}
        ...
        {!imageErrors.screen2 ? (
          <img 
            ...
            className="mobile-screen second"
            onError={() => handleImageError('screen2')}
          />
        ) : (
          <div className="mobile-screen placeholder second">App Preview 2</div>
        )}
      </div>
    </section>
  );
